...
class StoreListVC: UIViewController, CustomTopCategoryViewDelegate, RestaurantModelProtocol , UIScrollViewDelegate , categoryVCdelegate {
    ...
    func scrolltableviewreload() {
        fetchModel.getRestaurnatData(categoryIndex,selectedOrder: storeListFilterView.selectedOrder, selectedPayment: storeListFilterView.selectedPayment)
    }
...
extension StoreListVC : StoreListFilterViewDelegate {
    ...
    func presentStorefilterView(selectedOrder: Int, selectedPayment: Int) {
        ...
        fetchModel.getRestaurnatData(categoryIndex, selectedOrder: selectedOrder, selectedPayment: selectedPayment)
        print("필터 패치 :\(fetchModel.getRestaurnatData(categoryIndex, selectedOrder: selectedOrder, selectedPayment: selectedPayment))")
